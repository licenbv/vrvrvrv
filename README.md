if getgenv().LH then warn("LH Hub : Already executed!") return end
getgenv().LH = true
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | LH hub - Premium",
    SubTitle = " (https://discord.gg/VW8bSjde)", -- discord link
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/VW8bSjde") -- discord link
        end
    })
